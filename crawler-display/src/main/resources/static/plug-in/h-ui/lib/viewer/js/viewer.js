  ...
  $.extend(prototype, {
    ...
    initList: function () {
      ...
      this.$images.each(function (i) {
        ...
        var url = options.url;
        var dwUrl = this.getAttribute("dw-url");
    ...
    '<div class="viewer-container">' +
      ...
      '<div class="viewer-footer">' +
        ...
        '<ul class="viewer-toolbar">' +
          '<li class="viewer-zoom-in" data-action="zoom-in" title="放大"></li>' +
          '<li class="viewer-zoom-out" data-action="zoom-out" title="缩小"></li>' +
          '<li class="viewer-one-to-one" data-action="one-to-one" title="原始比例"></li>' +
          '<li class="viewer-reset" data-action="reset" title="刷新"></li>' +
          '<li class="viewer-prev" data-action="prev" title="上一张"></li>' +
          '<li class="viewer-play" data-action="play" title="播放"></li>' +
          '<li class="viewer-next" data-action="next" title="下一张"></li>' +
          '<li class="viewer-rotate-left" data-action="rotate-left" title="向左翻转"></li>' +
          '<li class="viewer-rotate-right" data-action="rotate-right" title="向右翻转"></li>' +
          '<li class="viewer-flip-horizontal" data-action="flip-horizontal" title="左右对换"></li>' +
          '<li class="viewer-flip-vertical" data-action="flip-vertical" title="上下对换"></li>' +
          '<li class="viewer-down" data-action="down" title="下载原图"></li>' +
        '</ul>' +
