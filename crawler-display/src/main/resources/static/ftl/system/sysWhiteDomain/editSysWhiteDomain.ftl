...
<html>
  ...
  <body style="background: #fff">  
	...
	<div class="ui-page-container ui-page-fixed">
	    <div class="ui-form">
		  <form action="${request.contextPath}/sysWhiteDomainController/editSysWhiteDomain.do" method="post" class="form form-horizontal" id="form-model-edit">
	...
	<#include "../../common/script/main-js.ftl" >
	  <script type="text/javascript" src="${request.contextPath}/plug-in/web/system/sysWhiteDomain/sysWhiteDomain-edit.js"></script> 
