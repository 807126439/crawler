...
<html>
  ...
  <body class="pos-r">
  	...
  	<div class="pos-a" style="width:480px;left:0;top:0; bottom:0; height:100%; border-right:1px solid #e5e5e5; ">
		  <div class="pd-20">
			  <form action="${request.contextPath}/roleController/addRole.do" method="post" class="form form-horizontal" id="form-role-add">
	...
	<script type="text/javascript" src="${request.contextPath}/plug-in/web/system/role/role-add.js"></script>
