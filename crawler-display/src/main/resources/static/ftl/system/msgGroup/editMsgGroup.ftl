...
<html>
  ...
  <div class="sect">
  	<div class="bd clearfix">
		<div class="ui-page-container ui-page-fixed">
		    <div class="ui-form">
		  <form action="${request.contextPath}/msgGroupController/editMsgGroup.do" method="post" class="form form-horizontal" id="form-model-edit">		    
	       		 ...
	       		 <div class="formControls col-xs-8"> 
						...
						<select class="ui-select ui-hide" name="groupType" id="groupType"  style="width:200px" disabled="disabled">
							...
							<#list typeDicts as ty  >
							 <option value="${ty.dictValue}" ${ty.dictValue == model.groupType?string("selected","") } >${ty.dictItem}</option>
							</#list>
						</select>
					</div>
				</div>
  ...
  <#include "../../common/script/main-js.ftl" >
	  ...
	  <script type="text/javascript" src="${request.contextPath}/plug-in/web/system/msgGroup/msgGroup-edit.js"></script> 
