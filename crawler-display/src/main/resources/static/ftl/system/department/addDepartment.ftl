  ...
  <head>
   ...
   <body style="background: #fff">  
		...
		<div class="ui-page-container ui-page-fixed">
		    <div class="ui-form">
			  <form action="${request.contextPath}/departmentController/addDepartment.do" method="post" class="form form-horizontal" id="form-model-add">
	    ...
	    <script type="text/javascript" src="${request.contextPath}/plug-in/web/system/department/department-add.js"></script>
