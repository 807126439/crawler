...
<html>
  <head>
	...
	<link href="${request.contextPath}/plug-in/main/css/wxPlatform.css" rel="stylesheet" type="text/css">
  ...
  <body> 
    ...
    <script type="text/javascript" src="${request.contextPath}/plug-in/h-ui/lib/zTree/v3/js/jquery.ztree.core.min.js"></script>
    <script type="text/javascript" src="${request.contextPath}/plug-in/h-ui/lib/zTree/v3/js/jquery.ztree.excheck.min.js"></script>
    <script type="text/javascript" src="${request.contextPath}/plug-in/main/js/addressBook.js"></script>
