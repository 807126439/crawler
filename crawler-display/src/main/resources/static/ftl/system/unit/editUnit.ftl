...
<html>
  ...
  <body style="background: #fff">  
		...
		<div class="ui-page-container">
		    <div class="ui-form">
			  <form action="${request.contextPath}/unitController/editUnit.do" method="post" class="form form-horizontal" id="form-model-edit">		    
				  <#include "./common/editItem.ftl" >
		 		<input type="hidden" name="id" value="${(model.id)!}"/>
		 		<div class="ui-form-item ui-form-btns">
		      	   <@m.if_own_auth authCode="editUnit">
		...
		<script type="text/javascript" src="${request.contextPath}/plug-in/web/system/unit/unit-edit.js"></script>
