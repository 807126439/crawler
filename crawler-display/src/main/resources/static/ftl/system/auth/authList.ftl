...
<body>
	          ...
	          <div class="ui-table-actions-right">
		           <div class="ui-btn-group">
			            <@m.if_own_auth authCode="skipAddAuth">
			            	<a href="javascript:void(0)" class="ui-btn size-s ui-btn-normal" onclick="auth_add('添加权限节点','${request.contextPath}/authController/skipAddAuth.do','850','510')">添加</a>
			             	<a href="javascript:void(0)" class="ui-btn size-s ui-btn-primary" onclick="auth_add('一键生成','${request.contextPath}/authController/skipCreateAuthAuto.do','850','510')">一键生成</a>
			            </@m.if_own_auth>
  ...
  <script type="text/javascript" src="${request.contextPath}/plug-in/web/system/auth/auth-list.js"></script>
