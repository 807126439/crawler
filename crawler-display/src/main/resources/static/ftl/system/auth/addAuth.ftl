  ...
  <body class="pos-r">
  	...
  	<div class="pos-a" style="width:300px;left:0;top:0; bottom:0; height:100%; border-right:1px solid #e5e5e5; ">
  	 ...
  	 <div  style="margin-left:300px;">
  	 	 <div class="pd-20">
			   <form action="${request.contextPath}/authController/addAuth.do" method="post" class="form form-horizontal" id="form-auth-add">
	...
	<script type="text/javascript" src="${request.contextPath}/plug-in/web/system/auth/auth-add.js"></script>	
