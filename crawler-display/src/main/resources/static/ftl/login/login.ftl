  ...
  <div class="login-container">
    <div class="login-header">
      <div class="login-header-inner">
        <div class="login-logowrap"><div class="login-logoblock" style="background-image: url(${request.contextPath}/plug-in/main/images/header-title.png);"></div></div>
      </div>
    </div>
    <div class="login-body">
      <div class="login-body-inner">
        <div class="login-form-wrapper">
          <form class="login-form" action="${request.contextPath}/j_spring_security_check" method="post">
            ...
            <div class="login-form-iptgroups">
              ...
              <div class="login-form-iptgroup">
              <span class="login-form-imagecode"><img src="${request.contextPath}/kaptcha" id="captchaImage"/></span>
