...
String parAuthId = (String )request.getAttribute("parAuthId");
out.print("<script type='text/javascript'> var zNodes = "+nodes+";var parAuthId = '"+parAuthId+"';</script>");
...
<html>
  <head>
   ...
   <body class="pos-r">
	...
	<script type="text/javascript" src="<%=path %>/plug-in/web/system/auth/auth-edit.js"></script>
