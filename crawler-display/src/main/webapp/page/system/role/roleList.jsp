...
<html>
  ...
  <body>
	<div class="ui-panel">
	        ...
	        <div class="ui-table-actions">
	          <div class="ui-table-actions-right">
	            ...
	            <m:if_own_auth authCode="skipAddRole">
	            	<a href="javascript:void(0)" class="ui-btn ui-btn-normal size-s" onclick="role_add('添加角色','roleController/skipAddRole.do','850','510')">添加角色</a>
	            </m:if_own_auth>         
	   ...
	   <script type="text/javascript" src="<%=path%>/plug-in/web/system/role/role-list.js"></script> 
