  ...
  <head>
   ...
   <body style="background: #fff">  
		...
		<div class="ui-page-container ui-page-fixed" style="margin: 10px auto;max-width: 650px">
		    ...
		    <div class="ui-form">
			  <form action="<%=path %>/validationPhoneAndChangePwd.do" method="post" class="form form-horizontal" id="form-model-add">
	    ...
	    <script type="text/javascript" src="<%=path%>/plug-in/web/system/user/validation-account.js"></script> 
