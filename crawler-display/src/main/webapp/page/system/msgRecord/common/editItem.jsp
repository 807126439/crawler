<%@ page language="java" pageEncoding="utf-8"%>
	 ...
	 <div class="ui-form-item">
	  ...
	  <div class="ui-input-block">    
	    <input type="text" id="" class="ui-input Wdate"  name="gmtCreate"  value="<fmt:formatDate value="${model.gmtCreate}" pattern="yyyy-MM-dd"/>" 
	 ...
	 <div class="ui-form-item">
	  ...
	  <div class="ui-input-block">    
	    <input type="text" id="" class="ui-input Wdate"  name="gmtModified"  value="<fmt:formatDate value="${model.gmtModified}" pattern="yyyy-MM-dd"/>" 
