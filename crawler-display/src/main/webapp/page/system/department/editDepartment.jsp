...
<html>
  ...
  <body style="background: #fff">  
	...
	<div class="ui-page-container ui-page-fixed">
	    <div class="ui-form">
		  <form action="<%=path %>/departmentController/editDepartment.do" method="post" class="form form-horizontal" id="form-model-edit">		    
	  ...
	  <script type="text/javascript" src="<%=path%>/plug-in/web/system/department/department-edit.js"></script> 
