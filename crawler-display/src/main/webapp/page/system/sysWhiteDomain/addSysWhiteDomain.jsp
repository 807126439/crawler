  ...
  <head>
   ...
   <body style="background: #fff">  
		...
		<div class="ui-page-container ui-page-fixed">
		    <div class="ui-form">
			  <form action="<%=path %>/sysWhiteDomainController/addSysWhiteDomain.do" method="post" class="form form-horizontal" id="form-model-add">
	    ...
	    <script type="text/javascript" src="<%=path%>/plug-in/web/system/sysWhiteDomain/sysWhiteDomain-add.js"></script> 
