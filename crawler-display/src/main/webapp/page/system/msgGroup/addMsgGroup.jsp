   ...
   <body style="background: #fff">  
  	...
  	<div class="bd clearfix">
		<div class="ui-page-container ui-page-fixed">
		    <div class="ui-form">
			  <form action="<%=path %>/msgGroupController/addMsgGroup.do" method="post" class="form form-horizontal" id="form-model-add">
	    ...
	    <script type="text/javascript" src="<%=path%>/plug-in/web/system/msgGroup/msgGroup-add.js"></script> 
