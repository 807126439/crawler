...
<html>
  ...
  <body style="background: #fff">  
		...
		<div class="ui-page-container">
		    <div class="ui-form">
			  <form action="<%=path %>/unitController/editUnit.do" method="post" class="form form-horizontal" id="form-model-edit">		    
	 ...
	 <script type="text/javascript" src="<%=path%>/plug-in/web/system/unit/unit-edit.js"></script> 
