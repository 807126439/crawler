  ...
  $(function() {
     	...
     	mtable = $("#account-table").dataTable({
			    ...
			    "aoColumns": [			    			  
                               ...
                               { "sTitle": "申请人","mDataProp":"chineseName"},                         
                               { "sTitle": "所在单位","mDataProp":"unit", },
                               { "sTitle": "联系电话","mDataProp":"phone", "bSortable": false },
                               { "sTitle": "联系邮箱","mDataProp":"email", "bSortable": false }, 
                            			...
                            			var html = "";                             		
	                              		if(typeof(view_account)!= "undefined"){
	                              			 if(view_account.length>0){
	                              			 	html+=view_account.format("审核个人注册信息",data,"审核");
	                              			 }                            			
	                              		}
