...
function createUploader(elem,opt) {
  ...
  var $wrap = $(elem),
    ...
    defaultOpt={
      ...
      accept: {
        title: '',
        extensions: 'gif,jpg,jpeg,bmp,png,tif,doc,docx,ppt,pptx,xls,xlsx,wps,dps,et,pdf,txt,rar,zip,3gp,mp4,avi,mpv2,mpg,mpe,mpeg,rmvb,rm,asf,divx,wmv,mkv,vob,flv,ogm,qt',
        mimeTypes: '*'
      },
      // swf文件路径
